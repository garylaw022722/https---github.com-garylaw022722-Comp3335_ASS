  ...
  <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50" style="background-color: #1A5276! important; ">
      ...
      <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800" style="background-color: #1A5276! important; ">
        <a class="mdl-navigation__link" href="../../php/checkStatus.php?tappedID=6" style="text-decoration: none;">
...
<!-- Start Edit Employee  -->
<div class="modal fade" id="editEmpolyeeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="editEmployee.php" method="POST">
          ...
          <div class="form-group">
            ...
            <label for="recipient-name" class="col-form-label">Birth of Date:</label>
            ...
            <input type="value" class="form-control" id="recipient-name" class="title">
            ...
            <label for="recipient-name" class="col-form-label">HKID:</label>
            <input type="text" class="form-control" id="recipient-name" class="title">
