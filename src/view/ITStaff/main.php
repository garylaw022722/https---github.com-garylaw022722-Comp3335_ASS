	...
	<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		...
		<div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50" style="background-color: #1A5276! important; ">
			...
			<nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800" style="background-color: #1A5276! important; ">
				<a class="mdl-navigation__link" href="../../php/checkStatus.php?tappedID=4" style="text-decoration: none;">
				...
				<a class="mdl-navigation__link" href="../../php/checkStatus.php?tappedID=5" style="text-decoration: none;">
					<div style="margin-left:50px;">
						<h5>
							Project
						</h5>
				...
				<a class="mdl-navigation__link" href="../../php/checkStatus.php?tappedID=11" style="text-decoration: none;">
					<div style="margin-left:50px;">
						<h5>
							Task
						</h5>
				...
				<a class="mdl-navigation__link" href="../../php/checkStatus.php?tappedID=12" style="text-decoration: none;">
					<div style="margin-left:50px;">
						<h5>
							Team
						</h5>
