 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../public/images/first.gif",  
			prevArrow : (new Image()).src="../public/images/prev.gif",
			lastArrow : (new Image()).src="../public/images/last.gif",
			nextArrow : (new Image()).src="../public/images/next.gif",
			rowsPerPage : 10,
			currPage : 1,
