              ...
              <tr>
                  <td style="vertical-align: top;" align="center">
                    ...
                    <form action="php/validationLogin.php" method="post">
                      ...
                      required
                      style="opacity: 0.6;height: 50px;border-radius: 15px;padding: 13px;"
            ...
            <tr style="margin-top:-30px;">
                <td align="center">
                   ...
                   margin-right: 40px;
                    ...
                    <input type="submit"
                         style="background-color: transparent;border: transparent;width: 100%;"
                   value="Login"
                    >
